Public Class frmDetalleEgreso_efectivo
   ...
   Private Sub frmDetalleEgreso_efectivo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
       ...
       Try
           ...
           Me.cmbTipo_egreso.Text = oTipo_egreso.GetOne(CInt(Me.lblid_Tipo_egreso.Text)).Rows(0).Item("nombre Tipo_egreso").ToString.Trim
       ...
       Try
           ...
           Select Case BanderaEgreso_efectivo
               Case 1 'GUARDA,REFRESCA LA GRILLA E INSERTA UNO NUEVO (AGREGAR)
                   ...
                   CType(Me.Owner, frmAbmEgreso_efectivo).RefrescarGrilla()
                   Me.CargarCombos()
   ...
   Handles dtpfecha.KeyDown, cmbEmpresa.KeyDown, cmbProveedor.KeyDown, cmbTipo_egreso.KeyDown
