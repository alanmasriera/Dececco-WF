Public Class frmDetalleVoz
   ...
   Private Sub ObtenerDatos()
       ...
       Me.chkcorresp.Checked = oVoz.corresp
   End Sub
   ...
   Private Sub AsignarDatos()
       ...
       oVoz.corresp = Me.chkcorresp.Checked
   End Sub
   ...
   Private Function ChequearVacios() As Boolean
       ...
       If _ 
       Me.txtnombre_voz.Text = "" or _
       Me.txticono.Text = "" or _
       Me.txtcodigo.Text = "" or _
       Me.txtcodigo_2.Text = "" or _
       Me.txtponderacion.Text = "" or _
       Me.txtrandom.Text = "" Then
           bandera = False
       Else
           bandera = True
       End If
   ...
   Handles txtnombre_voz.KeyPress, txticono.KeyPress, txtcodigo.KeyPress, txtcodigo_2.KeyPress, chkcorresp.KeyPress
