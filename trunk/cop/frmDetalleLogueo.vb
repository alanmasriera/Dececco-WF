Public Class frmDetalleLogueo
   ...
   Private Sub frmDetalleLogueo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
       Me.ttGeneral.SetToolTip(Me.btnBuscaUsuario, "Buscar Nuevo Usuario")
       Me.ttGeneral.SetToolTip(Me.btnGuardar, "Guardar Datos del Logueo")
   ...
   Private Sub ObtenerDatos()
       Me.lblid_usuario.Text = oLogueo.id_usuario.ToString
       Me.dtpfecha.Value = oLogueo.fecha
   End Sub

   Private Sub AsignarDatos()
       oLogueo.id_usuario = CInt(Me.lblid_usuario.Text)
       oLogueo.fecha = Me.dtpfecha.Value.Date
   End Sub
   ...
   Private Sub Guardar()
       Try
           Me.AsignarDatos()
           If oLogueo.Exist() Then
               If BanderaLogueo = 1 Then
                   MessageBox.Show("Sr. Usuario: Los Datos que Pretende Ingresar ya Fueron Cargados en el Sistema")
               Exit Sub
               ElseIf BanderaLogueo = 2 Then
               ...
               End If
           End If
           Select Case BanderaLogueo
               Case 1 'GUARDA,REFRESCA LA GRILLA E INSERTA UNO NUEVO (AGREGAR)
                   oLogueo.Guardar()
                   CType(Me.Owner, frmAbmLogueo).RefrescarGrilla()
                   Me.CargarCombos()
                   oLogueo.Insertar()
                   Me.ObtenerDatos()
                   Me.LimpiarControles()
