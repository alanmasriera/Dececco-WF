...
'''<summary>
'''Se trata de una clase de prueba para Usuario_entTest y se pretende que
'''contenga todas las pruebas unitarias Usuario_entTest. 
'''</summary>
<TestClass()> _
...
#End Region
   ...
   Public Sub ModificarUsuarioTest()
       Dim target As Usuario_ent = New Usuario_ent ' TODO: Inicializar en un valor adecuado
       Dim expected As DataTable = Nothing ' TODO: Inicializar en un valor adecuado
       target.Truncate()
       target.InsertOne()
       target.Cargar()
       target.Modificar(1) 
       target.nombre_Usuario = "modificado"
       target.Guardar()

       Dim dt As DataTable = New DataTable
       dt = target.ConsultarTodo
       Assert.IsTrue(CBool(dt.Rows(0).Item("nombre_Usuario").ToString = "modificado"),"no: " & dt.Rows(0).Item("nombre_Usuario").ToString)
   End Sub
   ...
   '''</summary>
   <TestMethod()> _
   Public Sub InsertarUsuarioTest()
       Dim target As Usuario_ent = New Usuario_ent ' TODO: Inicializar en un valor adecuado
   ...
   '''</summary>
   <TestMethod()> _
   Public Sub GetOneUsuarioTest()
       Dim target As Usuario_ent = New Usuario_ent ' TODO: Inicializar en un valor adecuado
       Dim id_Usuario As Integer = 1 ' TODO: Inicializar en un valor adecuado
       Dim expected As DataTable = Nothing ' TODO: Inicializar en un valor adecuado
       ...
       actual = target.GetOne(id_Usuario)
   ...
   '''</summary>
   <TestMethod()> _
   Public Sub ConsultarTodoUsuarioTest()
       Dim target As Usuario_ent = New Usuario_ent ' TODO: Inicializar en un valor adecuado
       Dim expected As DataTable = Nothing ' TODO: Inicializar en un valor adecuado
       Dim actual As DataTable
   ...
   Public Sub BuscarUsuarioTest()
       ...
       target.Insertar()
       target.nombre_Usuario = "prudente"
       target.Guardar()
   ...
   Public Sub BorrarUsuarioTest()
       ...
       target.Truncate()
       target.InsertOne()
       target.Borrar(id_Usuario) 

       Dim dt As DataTable = New DataTable
       dt = target.GetOne(id_Usuario) 
