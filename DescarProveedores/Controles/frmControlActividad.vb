        ...
        If odt.Rows.Count = posicion_tabla Then
            ...
            If rta = DialogResult.Yes Then
                ...
                If vgNumeroControl = 1 Then
                    ...
                    If Me.id_detalle_recurso <> 0 Then
                        With oDetalle_recurso
                            .Cargar()
                            .Modificar(Me.id_detalle_recurso)
                            .realizada = True
                            .Guardar()
                        End With
                    End If
        ...
        Select Case intNumeroControl
            ...
            Case 1
                If strCodigoTipo <> strCodigoTipoViejo Then
                    ...
                    If MessageBox.Show("¿Corresponde el control: " & strCodigoTipo & " - " & strTipo_voz & " ?", "Control", _
