Public Class frmLoginMain
    ...
    Private Sub OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK.Click
        ...
        Catch ex As Exception
            MessageBox.Show("No se ha podido conectar al servidor, verifique que los datos sean correctos y que Hamachi esté ejecutándose", "Error de conexión", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End Try
