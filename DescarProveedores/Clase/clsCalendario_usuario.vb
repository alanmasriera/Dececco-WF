...
Public Class Calendario_usuario
    ...
    Public Function GetMiembrosAnio(ByVal anio As Integer) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Calendario_usuario_GetMiembrosAnio", cnn.Coneccion)
    ...
    Public Function ObtenerHorasDisponiblesUsuario(ByVal id_usuario As Integer, ByVal fecha_inicio As DateTime, ByVal fecha_fin As DateTime) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_calendario_usuario_HorasTotalesEntreFechasPorUsuario", cnn.Coneccion)
    ...
    Public Function ObtenerHorasDisponiblesEntreFechas(ByVal fecha_inicio As DateTime, ByVal fecha_fin As DateTime) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_calendario_usuario_HorasTotalesEntreFechas", cnn.Coneccion)
    ...
    Public Function ObtenerPorDesdeFechaUsuario(ByVal fecha As DateTime, ByVal id_usuario As Integer) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_calendario_usuario_ObtenerPorFechausuario", cnn.Coneccion)

        oda.SelectCommand.CommandType = CommandType.StoredProcedure

        oda.SelectCommand.Parameters.Add("@fecha_inicio", SqlDbType.DateTime, 8, "fecha_inicio")
        oda.SelectCommand.Parameters("@fecha_inicio").Value = fecha
        oda.SelectCommand.Parameters.Add("@id_usuario", SqlDbType.Int, 4, "id_usuario")
        oda.SelectCommand.Parameters("@id_usuario").Value = id_usuario
