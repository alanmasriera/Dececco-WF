...
Public Class Cuerpo_factura_exporta_ent
    ...
    Public Sub Insertar()
        dt = New DataTable("Cuerpo_factura_exporta")
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)

        Me.AsignarTipos()

        Dim cmdins As New SqlCommand("cop_Cuerpo_factura_exporta_Insert", cnn.Coneccion)
    ...
    Public Sub Modificar(ByVal idCuerpo_factura_exporta As Integer)
        dt = New DataTable("Cuerpo_factura_exporta")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Cuerpo_factura_exporta WHERE id_cuerpo_factura = @id_Cuerpo_factura_exporta", cnn.Coneccion)
        da.SelectCommand.Parameters.AddWithValue("@id_Cuerpo_factura_exporta", idCuerpo_factura_exporta)
        da.Fill(dt)
        Me.AsignarTipos()
    ...
    Public Sub Borrar(ByVal idCuerpo_factura_exporta As Integer)
        dt = New DataTable("Cuerpo_factura_exporta")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Cuerpo_factura_exporta WHERE id_cuerpo_factura = " & _
        idCuerpo_factura_exporta, cnn.Coneccion)
        da.Fill(dt)
        ...
        Try
            Dim cmddel As New SqlCommand("cop_Cuerpo_factura_exporta_Delete", cnn.Coneccion)
    ...
    Public Function Cargar() As DataTable
        dt = New DataTable("Cuerpo_factura_exporta")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Cuerpo_factura_exporta WHERE id_cuerpo_factura = 0", cnn.Coneccion)
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)
        Return dt
    End Function
    ...
    Public Function Buscar(ByVal Nombre As String) As DataTable
        ...
        Dim oda As New SqlDataAdapter("cop_Cuerpo_factura_exporta_Find", cnn.Coneccion)
    ...
    Public Function ConsultarTodo() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Cuerpo_factura_exporta_GetAll", cnn.Coneccion)
    ...
    Public Function GetCmb() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Cuerpo_factura_exporta_GetCmb", cnn.Coneccion)
    ...
    Public Function GetOne(ByVal id_Cuerpo_factura_exporta As Integer) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Cuerpo_factura_exporta_GetOne", cnn.Coneccion)
    ...
    Public Function Exist() As Boolean
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Cuerpo_factura_exporta_Exist", cnn.Coneccion)
    ...
    Public Sub BorrarTodo()
        ...
        Command.CommandText = "DELETE FROM Cuerpo_factura_exporta"
    ...
    Public Sub Truncate()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "TRUNCATE TABLE Cuerpo_factura_exporta"
    ...
    Public Sub InsertOne()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "cop_Cuerpo_factura_exporta_InsertOne"
    ...
    Public Function Cargar_Archivo(ByVal path As String) As DataTable
        Dim odt As New DataTable("Cuerpo_factura_exporta")

        Dim oda As New System.Data.OleDb.OleDbDataAdapter( _
        "SELECT * FROM Cuerpo_factura_exporta.txt", cnntxt.Coneccion(path))
