...
Public Class Saldo_bancos_ent
    ...
    Public Sub Insertar()
        dt = New DataTable("Saldo_bancos")
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)

        Me.AsignarTipos()

        Dim cmdins As New SqlCommand("cop_Saldo_bancos_Insert", cnn.Coneccion)
    ...
    Public Sub Modificar(ByVal idSaldo_bancos As Integer)
        dt = New DataTable("Saldo_bancos")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Saldo_bancos WHERE id_saldo_banco = @id_Saldo_bancos", cnn.Coneccion)
        da.SelectCommand.Parameters.AddWithValue("@id_Saldo_bancos", idSaldo_bancos)
        da.Fill(dt)
        Me.AsignarTipos()
    ...
    Public Sub Borrar(ByVal idSaldo_bancos As Integer)
        dt = New DataTable("Saldo_bancos")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Saldo_bancos WHERE id_saldo_banco = " & _
        idSaldo_bancos, cnn.Coneccion)
        da.Fill(dt)
        ...
        Try
            Dim cmddel As New SqlCommand("cop_Saldo_bancos_Delete", cnn.Coneccion)
    ...
    Public Function Cargar() As DataTable
        dt = New DataTable("Saldo_bancos")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Saldo_bancos WHERE id_saldo_banco = 0", cnn.Coneccion)
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)
        Return dt
    End Function
    ...
    Public Function Buscar(ByVal Nombre As String) As DataTable
        ...
        Dim oda As New SqlDataAdapter("cop_Saldo_bancos_Find", cnn.Coneccion)
    ...
    Public Function ConsultarTodo() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Saldo_bancos_GetAll", cnn.Coneccion)
    ...
    Public Function GetCmb() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Saldo_bancos_GetCmb", cnn.Coneccion)
    ...
    Public Function GetOne(ByVal id_Saldo_bancos As Integer) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Saldo_bancos_GetOne", cnn.Coneccion)
    ...
    Public Function Exist() As Boolean
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Saldo_bancos_Exist", cnn.Coneccion)
    ...
    Public Sub BorrarTodo()
        ...
        Command.CommandText = "DELETE FROM Saldo_bancos"
    ...
    Public Sub Truncate()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "TRUNCATE TABLE Saldo_bancos"
    ...
    Public Sub InsertOne()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "cop_Saldo_bancos_InsertOne"
    ...
    Public Function Cargar_Archivo(ByVal path As String) As DataTable
        Dim odt As New DataTable("Saldo_bancos")

        Dim oda As New System.Data.OleDb.OleDbDataAdapter( _
        "SELECT * FROM Saldo_bancos.txt", cnntxt.Coneccion(path))
