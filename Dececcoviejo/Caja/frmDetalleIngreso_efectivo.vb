Public Class frmDetalleIngreso_efectivo
    ...
    Private Sub frmDetalleIngreso_efectivo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If vgFormularioPadre = "frmResumenCaja" Then
            Me.lblid_empresa.Text = CType(Me.Owner, frmResumenCaja).lblidEmpresa.Text
        ElseIf vgFormularioPadre = "frmDetallePago_cliente" Then
    ...
    Sub LimpiarControles()
        ...
        Me.cmbcliente.Text = ""
        'Me.chk_Archivado.Checked = False
    ...
    Private Sub ObtenerDatos()
        ...
        'Me.chk_Archivado.Checked = oIngreso_efectivo.archivado
    End Sub
    ...
    Private Sub AsignarDatos()
        ...
        'oIngreso_efectivo.archivado = Me.chk_Archivado.Checked
    End Sub
    ...
    Public Sub SoloLectura()
        ...
        'Me.chk_Archivado.Enabled = False
        ...
        Try
            ...
            Select Case BanderaIngreso_efectivo
                Case 1 'GUARDA,REFRESCA LA GRILLA E INSERTA UNO NUEVO (AGREGAR)
                    ...
                    Catch ex As Exception
                        CType(Me.Owner, frmDetalleRecibo_cliente_ingreso_efectivo).CargarIngreso_efectivo()
                    End Try
                    Me.CargarCombos()
    ...
    Handles txtcomprobante.KeyPress, chkcontrol.KeyPress
