Public Class frmAbmEmpleado
   ...
   Dim BanderaConsultaEmpleado As Integer

   Private Sub frmAbmEmpleado_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
       Me.ttGeneral.SetToolTip(Me.btnAgregar, "Incorporar Nuevo Empleado")
       Me.ttGeneral.SetToolTip(Me.btnBorrar, "Borrar un  Empleado Existente")
       Me.ttGeneral.SetToolTip(Me.btnModificar, "Modificar  un Empleado Existente")
       'Me.ttGeneral.SetToolTip(Me.btnConsultar, "Consultar Datos del  Empleado Existente")

       Dim odt As DataTable
       odt = oEmpleado.Cargar()
   ...
   Private Sub txtBuscar_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBuscar.TextChanged
       If Me.txtBuscar.Text = "" Then
           Me.txtBuscar.Text = " "
       End If
       odt = oEmpleado.Buscar(Me.txtBuscar.Text)
       Me.dgv1.DataSource = odt
   End Sub
   ...
   Private Sub Botones_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAgregar.Click, btnAyuda.Click, btnBorrar.Click, btnModificar.Click, btnSalir.Click
       ...
       Dim frmDetalle As New frmDetalleEmpleado
       ...
       Try
           Select Case btnTemp.Name
               ...
               Case "btnModificar"
                   ...
                   BanderaEmpleado = 2
                   Me.AddOwnedForm(frmDetalle)
                   oEmpleado.Modificar(CInt(Me.lblid_pk.Text))
                   frmDetalle.CargarCombos()
                   frmDetalle.ShowDialog()
                   RefrescarGrilla()
               Case "btnBorrar"
                   ...
                   oEmpleado.Borrar(CInt(Me.lblid_pk.Text))
                   RefrescarGrilla()
               Case "btnAyuda"
                   'Process.Start(PathAyuda + "frmAbmEmpleado.avi")
               Case "btnSalir"
                   Me.Close()
           End Select
           Me.txtBuscar.Text = ""
