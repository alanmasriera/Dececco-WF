Public Class frmDetalleDia_tarde

    Private Sub frmDetalleDia_tarde_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.ttGeneral.SetToolTip(Me.btnBuscaUsuario, "Buscar Nuevo Usuario")
        Me.ttGeneral.SetToolTip(Me.btnGuardar, "Guardar Datos del Dia_tarde")
    ...
    Private Sub ObtenerDatos()
        Me.lblid_usuario.Text = oDia_tarde.id_Usuario.ToString
        Me.dtpfecha.Value = oDia_tarde.fecha
    End Sub

    Private Sub AsignarDatos()
        oDia_tarde.id_Usuario = CInt(Me.lblid_Usuario.Text)
        oDia_tarde.fecha = Me.dtpfecha.Value.Date
    End Sub
    ...
    Private Sub Guardar()
        Try
            Me.AsignarDatos()
            If oDia_tarde.Exist() Then
                If BanderaDia_tarde = 1 Then
                    MessageBox.Show("Sr. Usuario: Los Datos que Pretende Ingresar ya Fueron Cargados en el Sistema")
                    Exit Sub
                ElseIf BanderaDia_tarde = 2 Then
                ...
                End If
            End If
            Select Case BanderaDia_tarde
                Case 1 'GUARDA,REFRESCA LA GRILLA E INSERTA UNO NUEVO (AGREGAR)
                    oDia_tarde.Guardar()
                    CType(Me.Owner, frmAbmDia_tarde).RefrescarGrilla()
                    Me.CargarCombos()
                    oDia_tarde.Insertar()
                    Me.ObtenerDatos()
                    Me.LimpiarControles()
    ...
    Handles cmbUsuario.KeyDown, dtpfecha.KeyDown
