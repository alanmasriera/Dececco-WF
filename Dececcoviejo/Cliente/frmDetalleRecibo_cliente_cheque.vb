Public Class frmDetalleRecibo_cliente_cheque

   Private Sub frmDetalleRecibo_cliente_cheque_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
       ...
       Me.ttGeneral.SetToolTip(Me.btnGuardar, "Guardar Datos del Recibo_cliente_cheque")
       ...
       Try
           ObtenerDatos()
            ...
            Me.cmbcheque_recibo.Text = oRecibo_cliente_cheque.GetOne(CInt(Me.lblid_cheque_recibo.Text)).Rows(0).Item("nombre_Cheque_recibo").ToString.Trim
       ...
       If BanderaRecibo_cliente_cheque  = 1 Then
           Me.LimpiarControles()
       End If
   ...
   Sub CargarCheque_recibo()
       Dim odt As New DataTable
        ...
        odt = oChequeRecibido.GetCmbChequeCliente(CInt(Me.lblid_cliente.Text))
       With Me.cmbCheque_recibo
           .DataSource = odt
           .DisplayMember = "nombre_cheque_recibo"
           .ValueMember = "id_cheque_recibo"
       End With
   ...
   Private Sub ObtenerDatos()
        '  Me.lblid_pago_cliente.Text = oRecibo_cliente_cheque.id_pago_cliente.ToString
       Me.lblid_cheque_recibo.Text = oRecibo_cliente_cheque.id_cheque_recibo.ToString
       Me.chkcontrol.Checked = oRecibo_cliente_cheque.control
   End Sub

   Private Sub AsignarDatos()
       oRecibo_cliente_cheque.id_pago_cliente = CInt(Me.lblid_pago_cliente.Text)
       oRecibo_cliente_cheque.id_cheque_recibo = CInt(Me.lblid_cheque_recibo.Text)
       oRecibo_cliente_cheque.control = Me.chkcontrol.Checked
   End Sub
   ...
   Private Sub Guardar()
       Try
           Me.AsignarDatos()
           If oRecibo_cliente_cheque.Exist() Then
               If BanderaRecibo_cliente_cheque = 1 Then
                   MessageBox.Show("Sr. Usuario: Los Datos que Pretende Ingresar ya Fueron Cargados en el Sistema")
               Exit Sub
               ElseIf BanderaRecibo_cliente_cheque = 2 Then
               ...
               End If
           End If
           Select Case BanderaRecibo_cliente_cheque
               Case 1 'GUARDA,REFRESCA LA GRILLA E INSERTA UNO NUEVO (AGREGAR)
                   oRecibo_cliente_cheque.Guardar()
                    CType(Me.Owner, frmDetallePago_cliente).RefrescarGrilla_2()
                   Me.CargarCombos()
