...
Public Class Recibo_cliente_cheque
    Inherits Recibo_cliente_cheque_ent

    'ejemplo de consulta con parametros
    Public Function Ejemplo(ByVal id_pago_cliente As Integer) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Recibo_cliente_cheque", cnn.Coneccion)
    ...
    Public Sub DeleteRecibo_cliente(ByVal id_pago_cliente As Integer)
        ...
        Command.CommandText = "cop_Recibo_cliente_cheque_DeleteRecibo_cliente"
    ...
    Public Sub UpdateID(ByVal id_pago_cliente As Integer)
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "cop_Recibo_cliente_cheque_UpdateID"
        Command.Parameters.Add("@id_pago_cliente", SqlDbType.Int, 4, "id_pago_cliente")
        Command.Parameters("@id_pago_cliente").Value = id_pago_cliente
    ...
    Public Function GetAllPagoCliente_2(ByVal id_pago_cliente As Integer) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Recibo_cliente_cheque_GetAllPagoCliente_2", cnn.Coneccion)
