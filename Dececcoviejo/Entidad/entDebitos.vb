...
Public Class Debitos_ent
    ...
    Private _id_debito As Int32
    Public ReadOnly Property id_debito() As Int32
        Get
            _id_debito = CInt(dr("id_debito"))
            Return _id_debito
        End Get
    end property
    ...
    Public Sub Insertar()
        dt = New DataTable("Debitos")
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)

        Me.AsignarTipos()

        Dim cmdins As New SqlCommand("cop_Debitos_Insert", cnn.Coneccion)
        cmdins.CommandType = CommandType.StoredProcedure
        da.InsertCommand = cmdins

        Dim prm As SqlParameter
        prm = da.InsertCommand.Parameters.Add("@id_debito", SqlDbType.int, 0, "id_debito")
    ...
    Public Sub Modificar(ByVal idDebitos As Integer)
        dt = New DataTable("Debitos")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Debitos WHERE id_debito = @id_Debitos", cnn.Coneccion)
        da.SelectCommand.Parameters.AddWithValue("@id_Debitos", idDebitos)
        da.Fill(dt)
        Me.AsignarTipos()
    ...
    Public Sub Borrar(ByVal idDebitos As Integer)
        dt = New DataTable("Debitos")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Debitos WHERE id_debito = " & _
        idDebitos, cnn.Coneccion)
        da.Fill(dt)
        ...
        Try
            Dim cmddel As New SqlCommand("cop_Debitos_Delete", cnn.Coneccion)
            cmddel.CommandType = CommandType.StoredProcedure
            da.DeleteCommand = cmddel
            Dim prm As SqlParameter
            prm = da.DeleteCommand.Parameters.Add("@id_debito", SqlDbType.Int, 4, "id_debito")
            dt.Rows(0).Delete()
            CrearComandoUpdate()
            Guardar()
    ...
    Public Function Cargar() As DataTable
        dt = New DataTable("Debitos")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Debitos WHERE id_debito = 0", cnn.Coneccion)
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)
        Return dt
    End Function
    ...
    Public Function Buscar(ByVal Nombre As String) As DataTable
        ...
        Dim oda As New SqlDataAdapter("cop_Debitos_Find", cnn.Coneccion)
    ...
    Public Function ConsultarTodo() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Debitos_GetAll", cnn.Coneccion)
    ...
    Public Function GetCmb() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Debitos_GetCmb", cnn.Coneccion)
    ...
    Public Function GetOne(ByVal id_Debitos As Integer) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Debitos_GetOne", cnn.Coneccion)

        oda.SelectCommand.CommandType = CommandType.StoredProcedure
        oda.SelectCommand.Parameters.Add("@id_debito", SqlDbType.Int, 4, "id_debito")
        oda.SelectCommand.Parameters("@id_debito").Value = id_Debitos
    ...
    Public Function Exist() As Boolean
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Debitos_Exist", cnn.Coneccion)
    ...
    Public Sub BorrarTodo()
        ...
        Command.CommandText = "DELETE FROM Debitos"
    ...
    Public Sub Truncate()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "TRUNCATE TABLE Debitos"
    ...
    Public Sub InsertOne()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "cop_Debitos_InsertOne"
    ...
    Public Function Cargar_Archivo(ByVal path As String) As DataTable
        Dim odt As New DataTable("Debitos")

        Dim oda As New System.Data.OleDb.OleDbDataAdapter( _
        "SELECT * FROM Debitos.txt", cnntxt.Coneccion(path))
