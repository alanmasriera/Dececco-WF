...
Public Class Iva_venta_ent
    ...
    Private _id_iva_venta As Int32
    Public ReadOnly Property id_iva_venta() As Int32
        Get
            _id_iva_venta = CInt(dr("id_iva_venta"))
            Return _id_iva_venta
        End Get
    end property
    ...
    Public Sub Insertar()
        dt = New DataTable("Iva_venta")
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)

        Me.AsignarTipos()

        Dim cmdins As New SqlCommand("cop_Iva_venta_Insert", cnn.Coneccion)
        cmdins.CommandType = CommandType.StoredProcedure
        da.InsertCommand = cmdins

        Dim prm As SqlParameter
        prm = da.InsertCommand.Parameters.Add("@id_iva_venta", SqlDbType.int, 0, "id_iva_venta")
    ...
    Public Sub Modificar(ByVal idIva_venta As Integer)
        dt = New DataTable("Iva_venta")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Iva_venta WHERE id_iva_venta = @id_Iva_venta", cnn.Coneccion)
        da.SelectCommand.Parameters.AddWithValue("@id_Iva_venta", idIva_venta)
        da.Fill(dt)
        Me.AsignarTipos()
    ...
    Public Sub Borrar(ByVal idIva_venta As Integer)
        dt = New DataTable("Iva_venta")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Iva_venta WHERE id_iva_venta = " & _
        idIva_venta, cnn.Coneccion)
        da.Fill(dt)
        ...
        Try
            Dim cmddel As New SqlCommand("cop_Iva_venta_Delete", cnn.Coneccion)
            cmddel.CommandType = CommandType.StoredProcedure
            da.DeleteCommand = cmddel
            Dim prm As SqlParameter
            prm = da.DeleteCommand.Parameters.Add("@id_iva_venta", SqlDbType.Int, 4, "id_iva_venta")
            dt.Rows(0).Delete()
            CrearComandoUpdate()
            Guardar()
    ...
    Public Function Cargar() As DataTable
        dt = New DataTable("Iva_venta")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Iva_venta WHERE id_iva_venta = 0", cnn.Coneccion)
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)
        Return dt
    End Function
    ...
    Public Function Buscar(ByVal Nombre As String) As DataTable
        ...
        Dim oda As New SqlDataAdapter("cop_Iva_venta_Find", cnn.Coneccion)
    ...
    Public Function ConsultarTodo() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Iva_venta_GetAll", cnn.Coneccion)
    ...
    Public Function GetCmb() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Iva_venta_GetCmb", cnn.Coneccion)
    ...
    Public Function GetOne(ByVal id_Iva_venta As Integer) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Iva_venta_GetOne", cnn.Coneccion)
    ...
    Public Function Exist() As Boolean
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Iva_venta_Exist", cnn.Coneccion)
    ...
    Public Sub BorrarTodo()
        ...
        Command.CommandText = "DELETE FROM Iva_venta"
    ...
    Public Sub Truncate()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "TRUNCATE TABLE Iva_venta"
    ...
    Public Sub InsertOne()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "cop_Iva_venta_InsertOne"
    ...
    Public Function Cargar_Archivo(ByVal path As String) As DataTable
        Dim odt As New DataTable("Iva_venta")

        Dim oda As New System.Data.OleDb.OleDbDataAdapter( _
        "SELECT * FROM Iva_venta.txt", cnntxt.Coneccion(path))
