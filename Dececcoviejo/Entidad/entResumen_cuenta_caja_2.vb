...
Public Class Resumen_cuenta_caja_2_ent
    ...
    Private _id_resumen_cuenta_caja As Int32
    Public ReadOnly Property id_resumen_cuenta_caja() As Int32
        Get
            _id_resumen_cuenta_caja = CInt(dr("id_resumen_cuenta_caja"))
            Return _id_resumen_cuenta_caja
        End Get
    end property
    ...
    Public Sub Insertar()
        dt = New DataTable("Resumen_cuenta_caja_2")
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)

        Me.AsignarTipos()

        Dim cmdins As New SqlCommand("cop_Resumen_cuenta_caja_2_Insert", cnn.Coneccion)
        cmdins.CommandType = CommandType.StoredProcedure
        da.InsertCommand = cmdins

        Dim prm As SqlParameter
        prm = da.InsertCommand.Parameters.Add("@id_resumen_cuenta_caja", SqlDbType.int, 0, "id_resumen_cuenta_caja")
    ...
    Public Sub Modificar(ByVal idResumen_cuenta_caja_2 As Integer)
        dt = New DataTable("Resumen_cuenta_caja_2")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Resumen_cuenta_caja_2 WHERE id_resumen_cuenta_caja = @id_Resumen_cuenta_caja_2", cnn.Coneccion)
        da.SelectCommand.Parameters.AddWithValue("@id_Resumen_cuenta_caja_2", idResumen_cuenta_caja_2)
        da.Fill(dt)
        Me.AsignarTipos()
    ...
    Public Sub Borrar(ByVal idResumen_cuenta_caja_2 As Integer)
        dt = New DataTable("Resumen_cuenta_caja_2")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Resumen_cuenta_caja_2 WHERE id_resumen_cuenta_caja = " & _
        idResumen_cuenta_caja_2, cnn.Coneccion)
        da.Fill(dt)
        ...
        Try
            Dim cmddel As New SqlCommand("cop_Resumen_cuenta_caja_2_Delete", cnn.Coneccion)
            cmddel.CommandType = CommandType.StoredProcedure
            da.DeleteCommand = cmddel
            Dim prm As SqlParameter
            prm = da.DeleteCommand.Parameters.Add("@id_resumen_cuenta_caja", SqlDbType.Int, 4, "id_resumen_cuenta_caja")
            dt.Rows(0).Delete()
            CrearComandoUpdate()
            Guardar()
    ...
    Public Function Cargar() As DataTable
        dt = New DataTable("Resumen_cuenta_caja_2")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Resumen_cuenta_caja_2 WHERE id_resumen_cuenta_caja = 0", cnn.Coneccion)
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)
        Return dt
    End Function
    ...
    Public Function Buscar(ByVal Nombre As String) As DataTable
        ...
        Dim oda As New SqlDataAdapter("cop_Resumen_cuenta_caja_2_Find", cnn.Coneccion)
    ...
    Public Function ConsultarTodo() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Resumen_cuenta_caja_2_GetAll", cnn.Coneccion)
    ...
    Public Function GetCmb() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Resumen_cuenta_caja_2_GetCmb", cnn.Coneccion)
    ...
    Public Function GetOne(ByVal id_Resumen_cuenta_caja_2 As Integer) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Resumen_cuenta_caja_2_GetOne", cnn.Coneccion)
    ...
    Public Function Exist() As Boolean
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Resumen_cuenta_caja_2_Exist", cnn.Coneccion)
    ...
    Public Sub BorrarTodo()
        ...
        Command.CommandText = "DELETE FROM Resumen_cuenta_caja_2"
    ...
    Public Sub Truncate()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "TRUNCATE TABLE Resumen_cuenta_caja_2"
    ...
    Public Sub InsertOne()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "cop_Resumen_cuenta_caja_2_InsertOne"
    ...
    Public Function Cargar_Archivo(ByVal path As String) As DataTable
        Dim odt As New DataTable("Resumen_cuenta_caja_2")

        Dim oda As New System.Data.OleDb.OleDbDataAdapter( _
        "SELECT * FROM Resumen_cuenta_caja_2.txt", cnntxt.Coneccion(path))
