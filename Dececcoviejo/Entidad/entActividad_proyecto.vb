...
Public Class Actividad_proyecto_ent
    ...
    Private _no_conformidad As Boolean
    Public Property no_conformidad() As Boolean
        Get
            _no_conformidad = CBool(dr("no_conformidad"))
            Return _no_conformidad
        End Get
        Set(ByVal Value As Boolean)
            dr("no_conformidad") = Value
        End Set
    End Property

    Private _motivo_no_conformidad As String
    Public Property motivo_no_conformidad() As String
        Get
            _motivo_no_conformidad = CStr(dr("motivo_no_conformidad"))
            Return _motivo_no_conformidad
        End Get
        Set(ByVal Value As String)
            dr("motivo_no_conformidad") = Value
        End Set
    End Property
    ...
    Public Sub Insertar()
        ...
        da.InsertCommand.Parameters.Add("@no_conformidad", SqlDbType.Bit, 4, "no_conformidad")
        da.InsertCommand.Parameters.Add("@motivo_no_conformidad", SqlDbType.VarChar, 200, "motivo_no_conformidad")
