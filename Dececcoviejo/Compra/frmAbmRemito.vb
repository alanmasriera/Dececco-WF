Public Class frmAbmRemito
   ...
   Private Sub txtBuscar_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBuscar.TextChanged
       If Me.txtBuscar.Text = "" Then
           Me.txtBuscar.Text = " "
       End If
       odt = oRemito.Buscar(Me.txtBuscar.Text)
       Me.dgv1.DataSource = odt
   End Sub
       ...
       Try
           Select Case btnTemp.Name
               ...
               Case "btnModificar"
                   ...
                   BanderaRemito = 2
                   Me.AddOwnedForm(frmDetalle)
                   oRemito.Modificar(CInt(Me.lblid_pk.Text))
                   frmDetalle.CargarCombos()
                   frmDetalle.ShowDialog()
                   RefrescarGrilla()
               Case "btnBorrar"
                   ...
                   End If
                    ...
                    oCuerpo_remito.DeleteRemito(CInt(Me.lblid_pk.Text), vgCodigoUsuario) ''

                   oRemito.Borrar(CInt(Me.lblid_pk.Text))
                   RefrescarGrilla()
               Case "btnAyuda"
