Public Class frmAbmPago_proveedor_2

    Dim odt As DataTable
    Dim BanderaConsultaPago_proveedor As Integer

    Private Sub frmAbmPago_proveedor_2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
