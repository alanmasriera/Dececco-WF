Public Class frmDetalleCuerpo_factura
    ...
    Private Sub frmDetalleCuerpo_factura_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.lblid_factura.Text = CType(Me.Owner, frmDetalleFactura).lblid_factura.Text
    End Sub
        ...
        Try
            ...
            Select Case BanderaCuerpo_factura
                Case 1 'GUARDA,REFRESCA LA GRILLA E INSERTA UNO NUEVO (AGREGAR)
                    ...
                    CType(Me.Owner, frmDetalleFactura).RefrescarGrilla()
                    Me.CargarCombos()
