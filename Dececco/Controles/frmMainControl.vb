Public Class frmMainControl
    ...
    Private Sub ts_borrar_control_Click(sender As System.Object, e As System.EventArgs) Handles ts_borrar_control.Click
        If MessageBox.Show("Desea Realmente Eliminar el Registro ", "BORRAR", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.No Then
            Exit Sub
        End If
        Dim odt1 As New DataTable
