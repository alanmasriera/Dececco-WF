Public Class frmDetalleUsuario_permiso
    ...
    Private Sub frmDetalleUsuario_permiso_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.cmbpermiso.Text = oPermiso.GetOne(CInt(Me.lblid_permiso.Text)).Rows(0).Item("nombre_Permiso").ToString.Trim
   ...
   Private Sub ObtenerDatos()
       ...
       Me.lblid_permiso.Text = oUsuario_permiso.id_permiso.ToString
        Me.chkhabilitado.Checked = CBool(oUsuario_permiso.habilitado)
   End Sub
   ...
   Private Sub Guardar()
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        '    Exit Sub
        'Else
        If Me.chkhabilitado.Checked = True Then
            'MessageBox.Show("")
        End If
