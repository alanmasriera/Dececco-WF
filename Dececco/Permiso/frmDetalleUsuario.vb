...
Public Class frmDetalleUsuario
    ...
    Private usuario_actual As ENtidades.Usuario
    ...
    Public Sub New(ByVal usuario As Entidades.Usuario)
    ...
    Private Sub frmDetalleUsuario_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If usuario_actual IsNot Nothing Then
                ObtenerDatos()
                Else
                usuario_actual = New Entidades.USUARIO
            End If
    ...
    Sub CargarCombos()
        ...
        With Me.cmbCalendario
            .DataSource = ControladoresLogica.ControladorCalendario.ObtenerCalendarios().Where(Function(x) x.es_calendario_base = True).ToList
            .DisplayMember = "nombre_calendario"
        End With
    ...
    Private Sub AsignarDatos()
        ...
        usuario_actual.id_calendario_laboral = DirectCast(Me.cmbCalendario.SelectedItem, Calendario_Laboral).id_calendario_laboral
    End Sub
    ...
    Private Sub Guardar()
        Try
            Me.AsignarDatos()
            If ControladorUsuarios.Exist(usuario_actual) IsNot Nothing Then
                If BanderaUsuario = 1 Then
            ...
            Select Case BanderaUsuario
                Case 1 'GUARDA,REFRESCA LA GRILLA E INSERTA UNO NUEVO (AGREGAR)
                    ...
                    Me.CargarCombos()
                    ControladorUsuarios.InsertarYcreaCalendario(usuario_actual)
                    Me.ObtenerDatos()
                    Me.LimpiarControles()
                    Me.txtnombre_usuario.Focus()
                Case 2 'GUARDA Y SALE (MODIFICAR)
                    ControladorUsuarios.Actualizar(usuario_actual)
                    Me.Close()
            End Select
        Catch ex As Exception
            MessageBox.Show(ex.Message)
    ...
    Private Function ChequearVacios() As Boolean
        ...
        If _
        Me.txtnombre_usuario.Text = "" Or
        Me.txtpassword_usuario.Text = "" Or
        Me.txtlegajo.Text = "" Or
        Me.txtapellido.Text = "" Or
