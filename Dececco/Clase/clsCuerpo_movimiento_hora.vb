...
Public Class Cuerpo_movimiento_hora
    ...
    Public Function GetTiempoPorDetalleRecurso(ByVal id_detalle_recurso As Integer, ByVal id_usuario As Integer) As Double
        Dim odt As New DataTable

        Dim oda As New SqlDataAdapter("cop_Cuerpo_movimiento_hora_GetHoras_detalleRecurso", cnn.Coneccion)
        ...
        oda.Fill(odt)
        If IsDBNull(odt.Rows(0)("Tiempo")) Then
            Return 0
            Else
            Double.Parse(odt.Rows(0)("Tiempo").ToString())
        End If
    End Function
