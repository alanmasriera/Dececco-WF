...
Public Class Actividad
    ...
    Public Function GetHorasTrabajadas(ByVal id_actividad_proyecto As Integer) As DataTable
        ...
        Return odt
    End Function
    Public Function GetTiempoTrabajadoSegundos(ByVal id_actividad_proyecto As Integer, ByVal id_usuario As Integer) As Double
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_actividad_getHorasTrabajadas", cnn.Coneccion)
        ...
        Return Convert.ToDouble(odt.Rows(0).Item("tiempo"))
    End Function
    ...
    Public Function GetActividadFromActPro(ByVal id_actividad_proyecto As Integer) As Integer
        Dim actividad As New Actividad

        Dim _act_pro As New Actividad_proyecto
        _act_pro.GetOne(id_actividad_proyecto)

        Dim id_actividad As Integer
        id_actividad = Convert.ToInt32(_act_pro.GetOne(id_actividad_proyecto).Rows(0).Item("Id actividad"))
