Public Class frmAbmDetalle_recurso

   Dim odt As DataTable
   Dim BanderaConsultaDetalle_recurso As Integer

   Private Sub frmAbmDetalle_recurso_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
       Me.ttGeneral.SetToolTip(Me.btnAgregar, "Incorporar Nuevo Detalle_recurso")
       Me.ttGeneral.SetToolTip(Me.btnBorrar, "Borrar un  Detalle_recurso Existente")
       Me.ttGeneral.SetToolTip(Me.btnModificar, "Modificar  un Detalle_recurso Existente")
       'Me.ttGeneral.SetToolTip(Me.btnConsultar, "Consultar Datos del  Detalle_recurso Existente")

       Dim odt As DataTable
       odt = oDetalle_recurso.Cargar()

       RefrescarGrilla()
       Me.txtBuscar.Focus()
       Me.lblTitulo.Text = "Detalle_recurso"
   ...
   Public Sub RefrescarGrilla()
       ...
       odt = oDetalle_recurso.ConsultarTodo()
   ...
   End Sub
    ...
    Private Sub txtBuscar_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBuscar.TextChanged
        If Me.txtBuscar.Text = "" Then
            Me.txtBuscar.Text = " "
        End If
        odt = oDetalle_recurso.Buscar(Me.txtBuscar.Text)
        Me.dgv1.DataSource = odt
    End Sub
