...
Public Class Gastos_ent
    ...
    Private _id_gasto As Int32
    Public ReadOnly Property id_gasto() As Int32
        Get
            _id_gasto = CInt(dr("id_gasto"))
            Return _id_gasto
        End Get
    end property
    ...
    Public Sub Insertar()
        dt = New DataTable("Gastos")
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)

        Me.AsignarTipos()

        Dim cmdins As New SqlCommand("cop_Gastos_Insert", cnn.Coneccion)
        cmdins.CommandType = CommandType.StoredProcedure
        da.InsertCommand = cmdins

        Dim prm As SqlParameter
        prm = da.InsertCommand.Parameters.Add("@id_gasto", SqlDbType.int, 0, "id_gasto")
    ...
    Public Sub Modificar(ByVal idGastos As Integer)
        dt = New DataTable("Gastos")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Gastos WHERE id_gasto = @id_Gastos", cnn.Coneccion)
        da.SelectCommand.Parameters.AddWithValue("@id_Gastos", idGastos)
        da.Fill(dt)
        Me.AsignarTipos()
    ...
    Public Sub Borrar(ByVal idGastos As Integer)
        dt = New DataTable("Gastos")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Gastos WHERE id_gasto = " & _
        idGastos, cnn.Coneccion)
        da.Fill(dt)
        ...
        Try
            Dim cmddel As New SqlCommand("cop_Gastos_Delete", cnn.Coneccion)
            cmddel.CommandType = CommandType.StoredProcedure
            da.DeleteCommand = cmddel
            Dim prm As SqlParameter
            prm = da.DeleteCommand.Parameters.Add("@id_gasto", SqlDbType.Int, 4, "id_gasto")
            dt.Rows(0).Delete()
            CrearComandoUpdate()
            Guardar()
    ...
    Public Function Cargar() As DataTable
        dt = New DataTable("Gastos")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Gastos WHERE id_gasto = 0", cnn.Coneccion)
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)
        Return dt
    End Function
    ...
    Public Function Buscar(ByVal Nombre As String) As DataTable
        ...
        Dim oda As New SqlDataAdapter("cop_Gastos_Find", cnn.Coneccion)
    ...
    Public Function ConsultarTodo() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Gastos_GetAll", cnn.Coneccion)
    ...
    Public Function GetCmb() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Gastos_GetCmb", cnn.Coneccion)
    ...
    Public Function GetOne(ByVal id_Gastos As Integer) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Gastos_GetOne", cnn.Coneccion)
    ...
    Public Function Exist() As Boolean
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Gastos_Exist", cnn.Coneccion)
    ...
    Public Sub BorrarTodo()
        ...
        Command.CommandText = "DELETE FROM Gastos"
    ...
    Public Sub Truncate()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "TRUNCATE TABLE Gastos"
    ...
    Public Sub InsertOne()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "cop_Gastos_InsertOne"
    ...
    Public Function Cargar_Archivo(ByVal path As String) As DataTable
        Dim odt As New DataTable("Gastos")

        Dim oda As New System.Data.OleDb.OleDbDataAdapter( _
        "SELECT * FROM Gastos.txt", cnntxt.Coneccion(path))
