...
Public Class Depositos_efectivo_ent
    ...
    Private _id_deposito_efectivo As Int32
    Public ReadOnly Property id_deposito_efectivo() As Int32
        Get
            _id_deposito_efectivo = CInt(dr("id_deposito_efectivo"))
            Return _id_deposito_efectivo
        End Get
    end property
    ...
    Public Sub Insertar()
        dt = New DataTable("Depositos_efectivo")
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)

        Me.AsignarTipos()

        Dim cmdins As New SqlCommand("cop_Depositos_efectivo_Insert", cnn.Coneccion)
        cmdins.CommandType = CommandType.StoredProcedure
        da.InsertCommand = cmdins

        Dim prm As SqlParameter
        prm = da.InsertCommand.Parameters.Add("@id_deposito_efectivo", SqlDbType.int, 0, "id_deposito_efectivo")
    ...
    Public Sub Modificar(ByVal idDepositos_efectivo As Integer)
        dt = New DataTable("Depositos_efectivo")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Depositos_efectivo WHERE id_deposito_efectivo = @id_Depositos_efectivo", cnn.Coneccion)
        da.SelectCommand.Parameters.AddWithValue("@id_Depositos_efectivo", idDepositos_efectivo)
        da.Fill(dt)
        Me.AsignarTipos()
    ...
    Public Sub Borrar(ByVal idDepositos_efectivo As Integer)
        dt = New DataTable("Depositos_efectivo")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Depositos_efectivo WHERE id_deposito_efectivo = " & _
        idDepositos_efectivo, cnn.Coneccion)
        da.Fill(dt)
        ...
        Try
            Dim cmddel As New SqlCommand("cop_Depositos_efectivo_Delete", cnn.Coneccion)
            cmddel.CommandType = CommandType.StoredProcedure
            da.DeleteCommand = cmddel
            Dim prm As SqlParameter
            prm = da.DeleteCommand.Parameters.Add("@id_deposito_efectivo", SqlDbType.Int, 4, "id_deposito_efectivo")
            dt.Rows(0).Delete()
            CrearComandoUpdate()
            Guardar()
    ...
    Public Function Cargar() As DataTable
        dt = New DataTable("Depositos_efectivo")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Depositos_efectivo WHERE id_deposito_efectivo = 0", cnn.Coneccion)
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)
        Return dt
    End Function
    ...
    Public Function Buscar(ByVal Nombre As String) As DataTable
        ...
        Dim oda As New SqlDataAdapter("cop_Depositos_efectivo_Find", cnn.Coneccion)
    ...
    Public Function ConsultarTodo() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Depositos_efectivo_GetAll", cnn.Coneccion)
    ...
    Public Function GetCmb() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Depositos_efectivo_GetCmb", cnn.Coneccion)
    ...
    Public Function GetOne(ByVal id_Depositos_efectivo As Integer) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Depositos_efectivo_GetOne", cnn.Coneccion)
    ...
    Public Function Exist() As Boolean
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Depositos_efectivo_Exist", cnn.Coneccion)
    ...
    Public Sub BorrarTodo()
        ...
        Command.CommandText = "DELETE FROM Depositos_efectivo"
    ...
    Public Sub Truncate()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "TRUNCATE TABLE Depositos_efectivo"
    ...
    Public Sub InsertOne()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "cop_Depositos_efectivo_InsertOne"
    ...
    Public Function Cargar_Archivo(ByVal path As String) As DataTable
        Dim odt As New DataTable("Depositos_efectivo")

        Dim oda As New System.Data.OleDb.OleDbDataAdapter( _
        "SELECT * FROM Depositos_efectivo.txt", cnntxt.Coneccion(path))
