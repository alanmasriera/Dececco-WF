...
Public Class Resumen_cuenta_caja_ent
    ...
    Public Sub Insertar()
        dt = New DataTable("Resumen_cuenta_caja")
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)

        Me.AsignarTipos()

        Dim cmdins As New SqlCommand("cop_Resumen_cuenta_caja_Insert", cnn.Coneccion)
    ...
    Public Sub Modificar(ByVal idResumen_cuenta_caja As Integer)
        dt = New DataTable("Resumen_cuenta_caja")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Resumen_cuenta_caja WHERE id_resumen_cuenta_caja = @id_Resumen_cuenta_caja", cnn.Coneccion)
        da.SelectCommand.Parameters.AddWithValue("@id_Resumen_cuenta_caja", idResumen_cuenta_caja)
        da.Fill(dt)
        Me.AsignarTipos()
    ...
    Public Sub Borrar(ByVal idResumen_cuenta_caja As Integer)
        dt = New DataTable("Resumen_cuenta_caja")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Resumen_cuenta_caja WHERE id_resumen_cuenta_caja = " & _
        idResumen_cuenta_caja, cnn.Coneccion)
        da.Fill(dt)
        ...
        Try
            Dim cmddel As New SqlCommand("cop_Resumen_cuenta_caja_Delete", cnn.Coneccion)
    ...
    Public Function Cargar() As DataTable
        dt = New DataTable("Resumen_cuenta_caja")
        da = New SqlClient.SqlDataAdapter("SELECT * FROM Resumen_cuenta_caja WHERE id_resumen_cuenta_caja = 0", cnn.Coneccion)
        da.MissingSchemaAction = MissingSchemaAction.AddWithKey
        da.Fill(dt)
        Return dt
    End Function
    ...
    Public Function Buscar(ByVal Nombre As String) As DataTable
        ...
        Dim oda As New SqlDataAdapter("cop_Resumen_cuenta_caja_Find", cnn.Coneccion)
    ...
    Public Function ConsultarTodo() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Resumen_cuenta_caja_GetAll", cnn.Coneccion)
    ...
    Public Function GetCmb() As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Resumen_cuenta_caja_GetCmb", cnn.Coneccion)
    ...
    Public Function GetOne(ByVal id_Resumen_cuenta_caja As Integer) As DataTable
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Resumen_cuenta_caja_GetOne", cnn.Coneccion)
    ...
    Public Function Exist() As Boolean
        Dim odt As New DataTable
        Dim oda As New SqlDataAdapter("cop_Resumen_cuenta_caja_Exist", cnn.Coneccion)
    ...
    Public Sub BorrarTodo()
        ...
        Command.CommandText = "DELETE FROM Resumen_cuenta_caja"
    ...
    Public Sub Truncate()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "TRUNCATE TABLE Resumen_cuenta_caja"
    ...
    Public Sub InsertOne()
        ...
        Command.Connection = oConexion.Coneccion
        Command.CommandText = "cop_Resumen_cuenta_caja_InsertOne"
    ...
    Public Function Cargar_Archivo(ByVal path As String) As DataTable
        Dim odt As New DataTable("Resumen_cuenta_caja")

        Dim oda As New System.Data.OleDb.OleDbDataAdapter( _
        "SELECT * FROM Resumen_cuenta_caja.txt", cnntxt.Coneccion(path))
