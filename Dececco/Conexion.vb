Public Class Conexion
    ...
    Public Function Coneccion() As SqlClient.SqlConnection
        ...
        ocnn.ConnectionString = "Data Source=" & strServer & ";" &
        ...
        'Dim aux As String = "Data Source=ESTEBAN;Initial Catalog=Dececco_Nuevo;User ID=sa;Password=Descar2;Trusted_Connection=False"

        'COn esta linea sola funciona
        'ocnn.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings("Descar").ConnectionString
